...
const FancyBox: React.FC<FancyBoxProps> = ({ srp, gameRtp, difference }) => {
  ...
  return (
    <div className="box bg-[#021024] text-white rounded-4xl max-w-sm min-w-[398px] mx-auto">
      ...
      <div className="box-body p-7 pt-0">
        <div className="text-center mb-4">
          <div className="relative max-w-[350px] h-[350px] mx-auto mt-[-60px] mb-[-105px]">
            <svg viewBox="0 0 350 350" className="relative w-[350px] h-[350px]">
              <defs>
              ...
              {["none", "blur(30px)", "blur(3.5px)"].map((blur, index) => (
                <motion.path
                  key={index}
                  ref={pathRef}
                  d=" M 82 223 A 102 102 62 1 1 262 223"
          ...
          <div className="text-[40px] font-[Montserrat] font-black mb-[-8]">
            88.2%
          </div>
          <div className="text-base font-semibold text-[#36FCF0] vertical-align-middle">
            <Image
